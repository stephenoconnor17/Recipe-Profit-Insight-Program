...
public class MyPanel extends JPanel {
	...
	String[] tableNames = { "Recipe", "Overall Cost", "Markup", "VAT Type", "VAT Paid", "Sale", "Difference",
			"Profit Margin", "Food Cost Diff" };
	...
	/**
	 * Initialises the table model (non-editable) and JTable with colour-coded
	 * renderers.
	 */
	...
	/**
	 * Reloads only recipes whose name contains the search string
	 * (case-insensitive).
	 */
	...
	/**
	 * Returns the Recipe object for the currently selected table row, or null if
	 * none selected.
	 */
	...
	/**
	 * Builds the bottom panel with editor buttons, sort dropdown, and keyword
	 * search.
	 */
