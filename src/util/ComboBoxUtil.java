...
/**
 * Utility methods for JComboBox items that use a numbered prefix format (e.g. "1. Flour").
 */
public class ComboBoxUtil {

	/** Strips the "N. " prefix from a combo box item string, returning just the name. */
